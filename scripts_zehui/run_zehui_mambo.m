...
create_obs_manually_flag = false ;
add_ped_flag = true ;
...
% for No.2, hit rover enter same time as start matlab
...
if add_rover_flag == true && name_rover == 2
    tracking_error_amount = 0.2 ;
elseif add_ped_flag == true
    tracking_error_amount = 0.3 ;
else
    tracking_error_amount = 0.5 ;
end
