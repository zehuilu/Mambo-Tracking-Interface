...
# Remember to change the total time!!!!!!!!!!!!!!!!!
        ...
        while t_now < 13.1:
            ...
            posi_now, velo_now, ori_quat, mambo = hf.get_states_mocap(sock, mambo)

            # compute some variables
            Rot_Mat, yaw_now, pitch_now, roll_now, yaw_prev, velo_body, yaw_rate = \
            hf.compute_states_changed(velo_now, ori_quat, yaw_prev, dt)
            ...
            if idx < 0:
                ...
                print("Total Time")
                print(t_now)
                traj_ref, T = hf.update_csv(Directory_traj)
